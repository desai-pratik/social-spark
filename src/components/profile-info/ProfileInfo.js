  ...
  return (
    <div className="profile-info">
      <div className="position-relative">
        <img src={currentUser._id === user._id ? currentUser.coverPicture ? currentUser.coverPicture : "/assets/banner-3.PNG" : user.coverPicture ? user.coverPicture : "/assets/banner-3.PNG"} className="w-100 profile-banner" alt="profile banner" title="Profile Banner" />
      ...
      <div className="position-relative profile-user-info">
        <img className="user" src={currentUser._id === user._id ? currentUser.profilePicture ? currentUser.profilePicture : "/assets/default-user.jpg" : user.profilePicture ? user.profilePicture : "/assets/default-user.jpg"} alt="user" title={user.username} />
