                ...
                <div className="row vh-100">
                    ...
                    <div className="col-md-6 flex-column d-flex justify-content-center ">
                        <form action="" className='bg-white p-5 rounded me-5' onSubmit={formik.handleSubmit}>
                            ...
                            <input
                                type="email"
                                className={`w-100 p-2 fs-6 rounded border-1 ${formik.touched.email && formik.errors.email ? 'is-invalid ' : ''}`}
                                placeholder='Email'
                            ...
                            <div className='position-relative mt-3'>
                                ...
                                <input
                                    ...
                                    className={`w-100 p-2 fs-6 rounded border-1 ${formik.touched.password && formik.errors.password ? 'is-invalid' : ''}`}
